...
export function WalletContent() {
  ...
  const fetchMessage = async () => {
    ...
    try {
      ...
      setStoredMessage("Error fetching message, have you posted, anon?");
    } finally {
    ...
    <div className="wallet-container">
      <div className="wallet-content">
        <div className="wallet-section">
          ...
          <p className="section-text">Movement Porto Testnet</p>
        </div>
          ...
          <div className="interaction-container">
            ...
            {storedMessage && (
              <div className="stored-message-container">
                <h3 className="section-subtitle">Stored Message:</h3>
                {isLoadingMessage ? (
                  <div className="loading-container">
                    <div className="loading-spinner"></div>
        ...
        <div className="wallet-section">
          <h2 className="section-title">Message Signing</h2>
